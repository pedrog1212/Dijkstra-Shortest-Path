...
/**
    ...
    void Graph::removeVertex( string label) {
        ...
        adjacencyList.erase(adjacencyList.begin() + index); // remove vetex from adjacency list

        // Adjust adjacency list indexes, substracting 1, from the indexes larger than the removed one
